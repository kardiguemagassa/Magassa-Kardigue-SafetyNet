...
public class PersonConstant {
    ...
    public static final String PERSON_List_EMPTY = "The list of people is empty, loading...";
    public static final String PERSON_LOADED = "Successfully loaded {} persons. ";
    public static final String SYSTEM_ERROR = "System error while saving persons in the repository:";
